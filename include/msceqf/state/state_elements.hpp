 ...
 *
 * @note Note that SOT3 element is excluded since multiple SOT3 elements will be reffered to through the features id
 */
 ...
 * freedom.
 *
 * @note Type-based index system inspired by: Geneva, Patrick, et al. "Openvins: A research platform for visual-inertial
 * estimation." 2020 IEEE International Conference on Robotics and Automation (ICRA). IEEE,
 * 2020. https://ieeexplore.ieee.org/document/9196524
 */
...
struct MSCEqFSDBState final : public MSCEqFStateElement
{
   ...
   *
   * @return Clone of the SDB element
   */
...
struct MSCEqFSE3State final : public MSCEqFStateElement
{
   ...
   *
   * @return Clone of the SE3 element
   */
...
struct MSCEqFInState final : public MSCEqFStateElement
{
   ...
   *
   * @return Clone of the In element
   */
...
struct MSCEqFSOT3State final : public MSCEqFStateElement
{
   ...
   *
   * @return Clone of the SOT3 element
   */
