...
int main(int argc, char** argv)
{
  ...
  const std::string dataset_path = std::string(argv[1]) + "/data/trajectory";
  const std::string results_path = std::string(argv[1]) + "/results/synthetic.csv";
  ...
  utils::SynteticDataParser data(dataset_path + "_imu.csv", dataset_path + "_gt.csv", dataset_path + "_feats.csv",
                                 imu_header, groundtruth_header, feats_header);
